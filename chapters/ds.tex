...
By combining Lemma \ref{lem:treaprotationbound} and Lemma \ref{lem:treapoperationsbounds} below we obtain a proof of Theorem \ref{thm:treapmainthm}, which will complete our analysis of treaps:
